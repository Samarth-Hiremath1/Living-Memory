...
Output ONLY valid JSON with these fields (omit any you can't confidently infer):
{
  ...
  "arrival_time": "3pm | late afternoon | evening | after 6pm | etc — exact wording the guest used, or null",
  "room_temperature_f": 68,
  "welcome_amenity": "cold-pressed juices | local wine | tea | fresh fruit | fireplace | etc or null",
